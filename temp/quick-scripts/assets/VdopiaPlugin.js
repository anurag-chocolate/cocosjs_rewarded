(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/VdopiaPlugin.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '3fc394aLopB6p1cgMjFt4ki', 'VdopiaPlugin', __filename);
// VdopiaPlugin.js
...
cc.Class({
    ...
    vdopiaAdEvent: function vdopiaAdEvent(adType, adEvent) {
    ...
    setAdRequestUserData: function setAdRequestUserData(age, birthDate, gender, maritalStatus, ethnicity, dmaCode, postal, curPostal, latitude, longitude) {
        if (cc.sys.platform == cc.sys.ANDROID) {
            console.log(VdopiaGlobal.LOG_TAG + "setAdRequestUserParams Android");
            jsb.reflection.callStaticMethod(VdopiaGlobal.JAVA_CLASS_NAME, "SetAdRequestUserParams", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;" + "Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", age, birthDate, gender, maritalStatus, ethnicity, dmaCode, postal, curPostal, latitude, longitude);
    ...
    setAdRequestAppData: function setAdRequestAppData(appName, pubName, appDomain, pubDomain, storeUrl, iabCategory) {
        if (cc.sys.platform == cc.sys.ANDROID) {
            console.log(VdopiaGlobal.LOG_TAG + "setAdRequestAppParams Android");
            jsb.reflection.callStaticMethod(VdopiaGlobal.JAVA_CLASS_NAME, "SetAdRequestAppParams", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", appName, pubName, appDomain, pubDomain, storeUrl, iabCategory);
        } else if (cc.sys.platform == cc.sys.IPHONE) {
    ...
    setAdRequestTestMode: function setAdRequestTestMode(isEnabled, hashID) {
        if (cc.sys.platform == cc.sys.ANDROID) {
            console.log(VdopiaGlobal.LOG_TAG + "setTestModeEnabled Android");
            jsb.reflection.callStaticMethod(VdopiaGlobal.JAVA_CLASS_NAME, "SetTestModeEnabled", "(ZLjava/lang/String;)V", isEnabled, hashID);
        } else if (cc.sys.platform == cc.sys.IPHONE) {
    ...
    prefetchInterstitialAd: function prefetchInterstitialAd(apikey) {
        if (cc.sys.platform == cc.sys.ANDROID) {
            console.log(VdopiaGlobal.LOG_TAG + "prefetchInterstitialAd Android");

            jsb.reflection.callStaticMethod(VdopiaGlobal.JAVA_CLASS_NAME, "SelectPluginType", "(Ljava/lang/String;)V", "js");

            jsb.reflection.callStaticMethod(VdopiaGlobal.JAVA_CLASS_NAME, "PrefetchInterstitialAd", "(Ljava/lang/String;)V", apikey);
        } else if (cc.sys.platform == cc.sys.IPHONE) {
    ...
    loadInterstitialAd: function loadInterstitialAd(apikey) {
        if (cc.sys.platform == cc.sys.ANDROID) {
            console.log(VdopiaGlobal.LOG_TAG + "loadInterstitialAd Android");

            jsb.reflection.callStaticMethod(VdopiaGlobal.JAVA_CLASS_NAME, "SelectPluginType", "(Ljava/lang/String;)V", "js");

            jsb.reflection.callStaticMethod(VdopiaGlobal.JAVA_CLASS_NAME, "LoadInterstitialAd", "(Ljava/lang/String;)V", apikey);
        } else if (cc.sys.platform == cc.sys.IPHONE) {
    ...
    prefetchRewardAd: function prefetchRewardAd(apikey) {
        if (cc.sys.platform == cc.sys.ANDROID) {
            console.log(VdopiaGlobal.LOG_TAG + "prefetchRewardAd Android");

            jsb.reflection.callStaticMethod(VdopiaGlobal.JAVA_CLASS_NAME, "SelectPluginType", "(Ljava/lang/String;)V", "js");

            jsb.reflection.callStaticMethod(VdopiaGlobal.JAVA_CLASS_NAME, "PrefetchRewardAd", "(Ljava/lang/String;)V", apikey);
        } else if (cc.sys.platform == cc.sys.IPHONE) {
    ...
    loadRewardAd: function loadRewardAd(apikey) {
        if (cc.sys.platform == cc.sys.ANDROID) {
            console.log(VdopiaGlobal.LOG_TAG + "loadRewardAd Android");

            jsb.reflection.callStaticMethod(VdopiaGlobal.JAVA_CLASS_NAME, "SelectPluginType", "(Ljava/lang/String;)V", "js");

            jsb.reflection.callStaticMethod(VdopiaGlobal.JAVA_CLASS_NAME, "LoadRewardAd", "(Ljava/lang/String;)V", apikey);
        } else if (cc.sys.platform == cc.sys.IPHONE) {
    ...
    showRewardAd: function showRewardAd(secret, userid, rewardName, rewardAmount) {
        if (cc.sys.platform == cc.sys.ANDROID) {
            console.log(VdopiaGlobal.LOG_TAG + "showRewardAd Android");
            jsb.reflection.callStaticMethod(VdopiaGlobal.JAVA_CLASS_NAME, "ShowRewardAd", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", secret, userid, rewardName, rewardAmount);
        } else if (cc.sys.platform == cc.sys.IPHONE) {
    ...
    isRewardAdAvailable: function isRewardAdAvailable() {
        if (cc.sys.platform == cc.sys.ANDROID) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=VdopiaPlugin.js.map
